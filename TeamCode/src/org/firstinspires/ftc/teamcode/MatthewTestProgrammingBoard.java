...
@TeleOp(name = "MatthewTestProgrammingBoard", group = "Test")
public class MatthewTestProgrammingBoard extends OpMode {
    ...
    public void loop() {
        ...
        if(previouslyPressed==false&&!digitalChannel.getState()) {
            motor.setPower(speeds[state]);
            state=(state+1)%3;
